...
type InputV2Props =
  | ({
      /** * Which field to render. It is the discriminant of this union, so setting * it narrows the rest of the props to that field's own — omit it and you * get the plain single-line field. */ fieldType?: 'text';
    } & InputTextProps)
