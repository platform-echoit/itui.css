...
function DialogFooter({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			className={cn("-mx-4 -mb-4 px-4 py-4 border-t border-neutral-subtle flex flex-col-reverse gap-2 sm:flex-row sm:justify-end", className)}
			{...props}
		/>
	);
}
...
function DialogTitle({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Title>) {
	return (
		<DialogPrimitive.Title
			...
			className={cn("text-xl font-semibold leading-7 text-center tracking-[-0.24px] text-ink ", className)}
			{...props}
		/>
	);
}
...
function DialogDescription({
	...
	return (
		<DialogPrimitive.Description
			...
			className={cn("text-ink text-base leading-6 text-center tracking-lg", className)}
			{...props}
		/>
	);
}
