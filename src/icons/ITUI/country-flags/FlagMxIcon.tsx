...
const FlagMxIcon = ({
  ...
  >
    ...
    <path d="M8.87012 11.9995C8.87012 13.7284 10.2717 15.13 12.0006 15.13C13.7295 15.13 15.131 13.7284 15.131 11.9995V10.9561H8.87012V11.9995Z" fill="#6DA544"/>
    <path d="M16.1731 9.9136H13.0426C13.0426 9.33732 12.5754 8.87012 11.9991 8.87012C11.4229 8.87012 10.9557 9.33732 10.9557 9.9136H7.8252C7.8252 10.4899 8.32718 10.9571 8.90342 10.9571H8.86868C8.86868 11.5334 9.33584 12.0006 9.91217 12.0006C9.91217 12.5769 10.3793 13.044 10.9557 13.044H13.0426C13.619 13.044 14.0861 12.5769 14.0861 12.0006C14.6624 12.0006 15.1296 11.5334 15.1296 10.9571H15.0948C15.6711 10.9571 16.1731 10.4899 16.1731 9.9136Z" fill="#FF9811"/>
    </g>
    <defs>
