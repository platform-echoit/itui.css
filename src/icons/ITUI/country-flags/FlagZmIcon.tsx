...
const FlagZmIcon = ({
  ...
  >
    ...
    <path d="M16.6957 11.999H12V23.999C13.4027 23.999 14.7488 23.7576 16 23.3153L16.6957 11.999Z" fill="#D80027"/>
    <path d="M20.0003 20.9425C22.4551 18.7452 24.0004 15.5528 24.0004 11.999H19.3047L20.0003 20.9425Z" fill="#FF9811"/>
    <path d="M16 11.999V23.3153C17.4905 22.7884 18.8458 21.9756 20 20.9425V11.999H16Z" fill="black"/>
    <path d="M22.174 7.82669H19.0436C19.0436 7.25041 18.5764 6.7832 18.0001 6.7832C17.4238 6.7832 16.9566 7.25041 16.9566 7.82669H13.8262C13.8262 8.40302 14.3282 8.87017 14.9044 8.87017H14.8697C14.8697 9.4465 15.3368 9.91366 15.9131 9.91366C15.9131 10.49 16.3803 10.9571 16.9566 10.9571H19.0436C19.6199 10.9571 20.0871 10.49 20.0871 9.91366C20.6634 9.91366 21.1306 9.4465 21.1306 8.87017H21.0958C21.6721 8.87013 22.174 8.40297 22.174 7.82669Z" fill="#FF9811"/>
    </g>
    <defs>
