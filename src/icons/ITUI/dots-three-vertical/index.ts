export { default as DotsThreeVerticalDuotoneIcon } from './DotsThreeVerticalDuotoneIcon';
export { default as DotsThreeVerticalFillIcon } from './DotsThreeVerticalFillIcon';
