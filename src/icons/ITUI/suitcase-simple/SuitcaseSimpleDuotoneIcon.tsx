...
const SuitcaseSimpleDuotoneIcon = ({
  width = 32,
  height = 32,
  color = 'none',
  ...props
  ...
  >
    <path
      opacity="0.2"
      d="M28 19V25C28 25.2652 27.8946 25.5196 27.7071 25.7071C27.5196 25.8946 27.2652 26 27 26H5C4.73478 26 4.48043 25.8946 4.29289 25.7071C4.10536 25.5196 4 25.2652 4 25V19H28Z"
      fill="#101010"
    />
    <path
